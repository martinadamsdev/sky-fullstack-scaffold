...
;(function webpackUniversalModuleDefinition(root, factory) {
  ...
  ((modules) => {
	...
	*/
        ...
        Util.each('String Object Array RegExp Function'.split(' '), (value) => {
          Util['is' + value] = (obj) => Util.type(obj) === value.toLowerCase()
        })

        Util.isObjectOrArray = (value) => Util.isObject(value) || Util.isArray(value)

        Util.isNumeric = (value) => !isNaN(parseFloat(value)) && isFinite(value)
	 ...
	 */
        ...
        module.exports = {
          parse: (name) => {
            ...
            // int || dmin-dmax || 0
            var dcount = decimal
              ? (!decimal[2] && parseInt(decimal[1], 10)) || Random.integer(dmin, dmax)
              : undefined
	...
	*/
        ...
        module.exports = {
          // 把字符串的第一个字母转换为大写。
          capitalize: (word) => (word + '').charAt(0).toUpperCase() + (word + '').substr(1),
          // 把字符串转换为大写。
	...
	*/
        ...
        var parser = (() => {
              ...
              function e(n, l) {
                function u(n) {
                  ...
                  return n
                    ...
                    .replace(/\f/g, '\\f')
                    .replace(/\r/g, '\\r')
                    .replace(/[\x00-\x07\x0B\x0E\x0F]/g, (n) => '\\x0' + l(n))
                    .replace(/[\x10-\x1F\x80-\xFF]/g, (n) => '\\x' + l(n))
                    .replace(/[\u0180-\u0FFF]/g, (n) => '\\u0' + l(n))
                    .replace(/[\u1080-\uFFFF]/g, (n) => '\\u' + l(n))
                }
                var t, r
                switch (n.length) {
            ...
            function u(n) {
              ...
              function k() {
                var l
                return (
                  63 === n.charCodeAt(qt) ? ((l = Hl), qt++) : ((l = null), 0 === Wt && e(Ol)), l
                )
              }
              function T() {
                var l, u, t
              ...
              var rl,
                ...
                fl = '|',
                sl = '"|"',
                hl = (n, l) => (l ? new Alternate(n, l[1]) : n),
                dl = (n, l, u) => new Match([n].concat(l).concat([u])),
                pl = '^',
                vl = '"^"',
                wl = () => new Token('start'),
                Al = '$',
                Cl = '"$"',
                gl = () => new Token('end'),
                bl = (n, l) => new Quantified(n, l),
                kl = 'Quantifier',
                Tl = (n, l) => (l && (n.greedy = !1), n),
                xl = '{',
                yl = '"{"',
                ml = ',',
                Rl = '","',
                Fl = '}',
                Ql = '"}"',
                Sl = (n, l) => new Quantifier(n, l),
                Ul = ',}',
                El = '",}"',
                Gl = (n) => new Quantifier(n, 1 / 0),
                Bl = (n) => new Quantifier(n, n),
                jl = '+',
                $l = '"+"',
                ql = () => new Quantifier(1, 1 / 0),
                Ll = '*',
                Ml = '"*"',
                Dl = () => new Quantifier(0, 1 / 0),
                Hl = '?',
                Ol = '"?"',
                Wl = () => new Quantifier(0, 1),
                zl = /^[0-9]/,
                Il = '[0-9]',
                Jl = (n) => +n.join(''),
                Kl = '(',
                ...
                Vl = '")"',
                Xl = (n) => n,
                Yl = (n) => new CaptureGroup(n),
                Zl = '?:',
                _l = '"?:"',
                nu = (n) => new Group('non-capture-group', n),
                lu = '?=',
                uu = '"?="',
                tu = (n) => new Group('positive-lookahead', n),
                ru = '?!',
                eu = '"?!"',
                ou = (n) => new Group('negative-lookahead', n),
                cu = 'CharacterSet',
                iu = '[',
                au = '"["',
                fu = ']',
                su = '"]"',
                hu = (n, l) => new CharSet(!!n, l),
                du = 'CharacterRange',
                pu = '-',
                vu = '"-"',
                wu = (n, l) => new CharacterRange(n, l),
                Au = 'Character',
                Cu = /^[^\\\]]/,
                gu = '[^\\\\\\]]',
                bu = (n) => new Literal(n),
                ku = '.',
                Tu = '"."',
                xu = () => new Token('any-character'),
                yu = 'Literal',
                mu = /^[^|\\/.[()?+*$^]/,
                Ru = '[^|\\\\\\/.[()?+*$\\^]',
                Fu = '\\b',
                Qu = '"\\\\b"',
                Su = () => new Token('backspace'),
                Uu = () => new Token('word-boundary'),
                Eu = '\\B',
                Gu = '"\\\\B"',
                Bu = () => new Token('non-word-boundary'),
                ju = '\\d',
                $u = '"\\\\d"',
                qu = () => new Token('digit'),
                Lu = '\\D',
                Mu = '"\\\\D"',
                Du = () => new Token('non-digit'),
                Hu = '\\f',
                Ou = '"\\\\f"',
                Wu = () => new Token('form-feed'),
                zu = '\\n',
                Iu = '"\\\\n"',
                Ju = () => new Token('line-feed'),
                Ku = '\\r',
                Nu = '"\\\\r"',
                Pu = () => new Token('carriage-return'),
                Vu = '\\s',
                Xu = '"\\\\s"',
                Yu = () => new Token('white-space'),
                Zu = '\\S',
                _u = '"\\\\S"',
                nt = () => new Token('non-white-space'),
                lt = '\\t',
                ut = '"\\\\t"',
                tt = () => new Token('tab'),
                rt = '\\v',
                et = '"\\\\v"',
                ot = () => new Token('vertical-tab'),
                ct = '\\w',
                it = '"\\\\w"',
                at = () => new Token('word'),
                ft = '\\W',
                st = '"\\\\W"',
                ht = () => new Token('non-word'),
                dt = '\\c',
                pt = '"\\\\c"',
                vt = 'any character',
                wt = (n) => new ControlCharacter(n),
                At = '\\',
                Ct = '"\\\\"',
                gt = /^[1-9]/,
                bt = '[1-9]',
                kt = (n) => new BackReference(n),
                Tt = '\\0',
                xt = '"\\\\0"',
                yt = /^[0-7]/,
                mt = '[0-7]',
                Rt = (n) => new Octal(n.join('')),
                Ft = '\\x',
                Qt = '"\\\\x"',
                St = /^[0-9a-fA-F]/,
                Ut = '[0-9a-fA-F]',
                ...
                Gt = '\\u',
                Bt = '"\\\\u"',
                jt = (n) => new Unicode(n.join('')),
                $t = () => new Token('null-character'),
                qt = 0,
                Lt = 0,
                Mt = 0,
                Dt = {
              ...
              if (
                ((Token.offset = t), (Token.text = u), (rl = cl()), null !== rl && qt === n.length)
              )
                return rl
              throw (
                (o(Ot),
	 ...
	 */
	    ...
	    */
          ...
          literal: (node, result, cache) => (node.escaped ? node.body : node.text),
          // Unicode \u
          unicode: (node, result, cache) => String.fromCharCode(parseInt(node.code, 16)),
          // 十六进制 \xFF
          hex: (node, result, cache) => String.fromCharCode(parseInt(node.code, 16)),
          // 八进制 \0
          octal: (node, result, cache) => String.fromCharCode(parseInt(node.code, 8)),
          // 反向引用
          'back-reference': (node, result, cache) => cache[node.code] || '',
          /*
	 ...
	 */
        ...
        function toJSONSchema(template, name, path /* Internal Use Only */) {
          ...
          switch (result.type) {
            case 'array':
              result.items = []
              Util.each(template, (value, index) => {
                result.items.push(toJSONSchema(value, index, result.path))
              })
              break
            case 'object':
              result.properties = []
              Util.each(template, (value, name) => {
            ...
            for (var i = 0; i < keys.length; i++) {
              result.push.apply(
                ...
                this.diff(
                  (() => {
                    var property
                    Util.each(schema.properties, (item /*, index*/) => {
	...
	*/
        var Assert = {
          message: (item) =>
            (item.message || "[{utype}] Expect {path}'{ltype} {action} {expected}, but is {actual}")
          ...
          notEqual: (type, path, actual, expected, result, message) => {
            if (actual !== expected) return true
            var item = {
              path: path,
              type: type,
          ...
          greaterThan: (type, path, actual, expected, result, message) => {
            if (actual > expected) return true
            var item = {
              path: path,
              type: type,
          ...
          lessThan: (type, path, actual, expected, result, message) => {
            if (actual < expected) return true
            var item = {
              path: path,
              type: type,
	...
	*/
        try {
          ...
          window.Event = (type, bubbles, cancelable, detail) => {
	...
	*/
        ...
        MockXMLHttpRequest.setup = (settings) => {
        ...
        Util.extend(MockXMLHttpRequest.prototype, {
          ...
          getAllResponseHeaders: function () {
            ...
            for (var h in responseHeaders) {
              if (!Object.hasOwn(responseHeaders, h)) continue
